...
if(localStorage.getItem('tasks')){  
    //create ticket from local storage to UI
...
textArea.addEventListener('keydown',function(e){
    ...
    if(key === "Enter"){
        ...
        generateTicket(textArea.value);// genearting ticket from ui
        textArea.value = "";
...
function generateTicket(task){
    ...
    let stringifyiedArr = JSON.stringify(ticketArr);
    localStorage.setItem('tasks',stringifyiedArr);
    console.log(ticketArr);
